<script lang='ts'>
    ...
    import { PreventDragClick } from "$lib/utils/PreventDragClick";
    ...
    onMount(() => {
        ...
        if (preventDragClick.mouseMoved) return;
            ...
            sphereBody.applyForce(new CANNON.Vec3(500, 300, 0), sphereBody.position);
        });

        const preventDragClick = new PreventDragClick(rendererContainer);
